...
class LSTM(nn.Module):
    def __init__(self, input_size=1, hidden_size=20, h=None, c=None):
        super().__init__()
        """
        Inputs:
        - input_size: Number of features in input vector
...
class Embedding(nn.Module):
    def __init__(self, num_embeddings, embedding_dim, padding_idx):
        ...
        self.weight = torch.randn(self.num_embeddings, self.embedding_dim, requires_grad=True)
    ...
    def forward(self, inputs):
        ...
        weight = weight * self.padding_mask
